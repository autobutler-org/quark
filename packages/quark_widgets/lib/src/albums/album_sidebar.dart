...
class AlbumSidebar extends StatelessWidget {
  ...
  /// Called with a user album whose menu was asked for, by its `more_vert`
  /// button, a long press, or a right-click. Never called for a system album,
  /// which gets no button either.
