...
/// The form an admin fills in to add an account: a username and an initial
...
/// what the admin saw.
///
/// The text fields are [State] because they are the form's own transient
/// input, thrown away when the dialog closes. The outcome leaves through
/// [onSubmit].
///
/// Key prefixes: `create_user_username`, `create_user_password`,
/// `create_user_confirm`, `create_user_cancel`, and `create_user_submit`.
///
/// ```dart
/// showDialog<void>(
///   context: context,
