...
`); err != nil {
	...
	// Stop at 008: 013 gives albums an owner and deletes them when there is none.
...
// perUserPhotosVersion is 013_per_user_photos, the migration that gives
// favorites and albums an owner (#1912).
const perUserPhotosVersion = 13
...
// jobOwnerVersion is 014_job_owner, the migration that records who queued a
// job (#1979).
const jobOwnerVersion = 14
