...
// members' grants, and /chat/channels/:id/events its signed membership and key events. No route is admin-only;
// admins may manage any channel but, like everyone else, list only the channels they are members of, and keys and
// events are for members alone. A channel the caller may not see is a 404.
package v0_chat
