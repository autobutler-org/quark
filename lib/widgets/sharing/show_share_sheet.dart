      ...
      builder: (sheetContext, _) {
        ...
        return ShareSheet(
          ...
          onAdd: (principal, level) =>
              report(controller.share(principal, level), 'share this'),
          onSetLevel: (principal, level) async {
            final demoting =
                controller.directLevel(principal) == AccessLevel.owner &&
            ...
            await report(controller.share(principal, level), 'change access');
          },
