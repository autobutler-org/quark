    ...
    "paths": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0_auth.deleteAccountBody"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "no session, or the session's account no longer exists",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
                    ...
                    "429": {
                        "description": "too many attempts from this address; nothing is deleted",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/auth/recover": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The account, its recovery phrase, the new password and optionally its re-wrapped chat keys",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0_auth.recoverAccountBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/recover/keys": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The account and its recovery phrase",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0_auth.recoverChatKeysBody"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "a wrong phrase or unknown username",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
                    ...
                    "404": {
                        "description": "the account has no chat keys yet",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/chat/channels": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "1 adds the channels an admin is not in; refused for anyone else",
                        "name": "all",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "403": {
                        "description": "all=1 from an account that isn't an admin",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/chat/channels/{id}/events/{eventId}/signature": {
            "put": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "no such channel or event, or the caller isn't the event's actor",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/chat/channels/{id}/members": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "not exactly one account or group, or a level other than read, write or owner, or demoting the last owner when the caller is not an admin",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "not exactly one account or group, everyone on general, or the last owner when the caller is not an admin",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/chat/channels/{id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Page backward from this message id",
                        "name": "before",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Page forward from this message id",
                        "name": "after",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "At most this many, 50 by default, capped at 200",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/chatutil.ListMessagesResult"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v0_chat.postMessageBody"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "ciphertext too short, or a key version the channel doesn't have",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
                    ...
                    "403": {
                        "description": "the caller can only read the channel",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/chat/keys/me": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "the caller has no chat keys yet",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "The caller's chat identity; createdAt and updatedAt are ignored",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "keys of the wrong size or shape, or a body over 8 KiB",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/chatutil.PublicKeys"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                    ...
                    "404": {
                        "description": "no such active account, or it has no chat keys yet",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/chat/messages/{id}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "the caller neither wrote it nor owns the channel",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
                    "404": {
                        "description": "no such message, or the caller isn't in its channel",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/settings/remote-access/devices": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v0_settings.PairDeviceResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                    ...
                    "409": {
                        "description": "Custom tailnet, remote access off, or no household",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v0_users.SetAvatarResponse"
                        }
                    },
                    "400": {
                    ...
                    "413": {
                        "description": "Larger than 10 MiB",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
        ...
        "/users/{id}/avatar": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Cache-buster, the picture's avatarUpdatedAt; ignored by the Quark",
                        "name": "v",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "chatutil.Keys": {
            ...
            "properties": {
                ...
                "kdfParams": {
                    "description": "KdfParams is the client's JSON object recording the Argon2id cost.",
                    "type": "object"
                },
                "saltPw": {
                    "type": "array",
                ...
                "wrappedByPhrase": {
                    "description": "WrappedByPhrase and SaltRp are both present or both absent.",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "chatutil.Message": {
            ...
            "properties": {
                "authorId": {
                    "description": "AuthorID is absent once the author's account is deleted.",
                    "type": "integer"
                },
                "channelId": {
                    "type": "integer"
        ...
        "v0_settings.PairDeviceResponse": {
            "type": "object",
            "properties": {
                "authKey": {
                    "description": "AuthKey is a single-use Headscale pre-auth key in the Quark's household.",
                    "type": "string"
                },
                "controlUrl": {
                    "description": "ControlURL is the Headscale server the device registers with.",
                    "type": "string"
                },
                "quarkAddress": {
                    "description": "QuarkAddress is the Quark's URL on the tailnet.",
                    "type": "string"
                }
            }
        },
        ...
        "v0_users.SetAvatarResponse": {
            "type": "object",
            "properties": {
                "avatarUpdatedAt": {
                    "description": "AvatarUpdatedAt is the new picture's version in Unix milliseconds,\nthe value clients append to the avatar URL as ?v=.",
                    "type": "integer"
                }
            }
        },
