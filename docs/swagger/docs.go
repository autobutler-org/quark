...
const docTemplate = `{
        ...
        "/thumbnails/{filePath}": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Not Found. clientRender is true when a client should render the thumbnail and PUT it",
                        "schema": {
                            "$ref": "#/definitions/v0_thumbnails.clientRenderResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        ...
        "v0_thumbnails.clientRenderResponse": {
            "type": "object",
            "properties": {
                "clientRender": {
                    "description": "ClientRender tells a client that may write the file to render its\nthumbnail (JPEG, long edge 400) and PUT it to /thumbnails/{filePath}.",
                    "type": "boolean"
                },
                "error": {
                    "type": "string"
                ...
                "modTime": {
                    "description": "ModTime is the file's modification time, so a client can remember a\nrender that failed for this version of the file and not retry it.",
                    "type": "string"
                }
            }
        },
