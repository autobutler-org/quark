        ...
        "/videos/transcode/formats": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Relative path to the video the formats are for",
                        "name": "relPath",
                        "in": "query"
                    }
                ],
        ...
        "/videos/trim": {
            "post": {
                ...
                "responses": {
                    ...
                    "422": {
                        "description": "Unprocessable Entity — the video's container can't be trimmed",
                        "schema": {
                            "$ref": "#/definitions/serverutil.Response"
                        }
                    },
    ...
    "definitions": {
        ...
        "v0_videos.transcodeVideoRequest": {
            ...
            "properties": {
                ...
                "quality": {
                    "description": "Quality is optional. A conversion copies the streams, so original is\nthe only quality; small, which needed a re-encode, is refused.",
                    "type": "string",
                    "enum": [
                        "original"
                    ]
        ...
        "v0_videos.trimVideoResponse": {
            ...
            "properties": {
                "actualStartMs": {
                    "description": "ActualStartMs is where the clip really begins in the source: startMs\nsnapped back to the keyframe at or before it.",
                    "type": "integer"
                },
                "relPath": {
                    "type": "string"
